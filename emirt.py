...
class MIRT(nn.Module):
    def __init__(self, user_num, item_num, latent_dim,  args_config):
        ...
        self.net = MIRTNet(user_num, item_num,latent_dim).to(device)
    ...
    def get_weights(self,users, infos):
        ...
        # accelerate by batch gradient descent
    ...
    def train(self, train_data, test_data=None) -> ...:
        ...
        trainer = torch.optim.AdamW(self.net.parameters(), lr=self.config.lr)
        loss_means = []
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--dim", type=int, default=10, help="dim_size"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--lr", type=float, default=0.003, help="Learning rate for cdm."
    )
    parser.add_argument(
